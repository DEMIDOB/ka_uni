    ...
    return Scaffold(
      appBar: AppBar(
            ...
            AnimatedSwitcher(
              ...
              child: settingsVM.showingProfile.value
                ...
                children: [
                  ...
                  Text(vm.student.name.firstName, style: theme.textTheme.titleLarge?.copyWith(color: theme.colorScheme.primary),)
                ],
              ),
            )
          ],
        ...
        leading: CupertinoButton(
          ...
          child: const Icon(CupertinoIcons.arrow_left_square, color: Colors.transparent,),
        ),
        actions: [
          CupertinoButton(
            onPressed: () {
