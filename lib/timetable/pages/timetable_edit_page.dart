...
class _TimetableEditPageState extends State<TimetableEditPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final modulesById = _modulesById(kitProvider.campusManager.rowModules.values);
  ...
  Future<void> _openTutorialDialog(
    ...
    String selectedModuleId =
        existing?.moduleId ?? moduleList.first.id;
          ...
          builder: (context, setState) {
            return AlertDialog(
                ...
                child: Column(
                  ...
                  children: [
                    DropdownButtonFormField<String>(
                      ...
                      decoration:
                          const InputDecoration(labelText: "Modul auswählen"),
                      items: moduleList
                          .map(
                    ...
                    DropdownButtonFormField<Weekday>(
                      ...
                      decoration:
                          const InputDecoration(labelText: "Wochentag"),
                    ...
                    DropdownButtonFormField<int>(
                      ...
                      decoration:
                          const InputDecoration(labelText: "Zeitblock"),
                      items: _blockOptions
                          .map(
                      ...
                      onChanged: (value) {
                        if (value == null) return;
                        setState(() => selectedBlockIndex = value);
                      },
                    ),
                    const SizedBox(height: 12),
                    TextField(
                      ...
                      decoration: const InputDecoration(
                        ...
                        hintText: "z.B. Raum, Ansprechpartner, Hinweise",
                      ),
                      maxLines: 3,
                    ),
                  ],
              ...
              actions: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    final module = modulesById[selectedModuleId];
                    if (module == null) {
                      return;
                    }
                    ...
                    final tutorial = existing != null
                        ? existing.copyWith(
                            moduleId: module.id,
                            moduleTitle: module.title.trim().isEmpty
                                ? module.title
                                : module.title.trim(),
  ...
  Future<void> _showNoModulesDialog(BuildContext context) {
    return showDialog<void>(
      context: context,
      builder: (dialogContext) => AlertDialog(
        title: const Text("Keine Module verfügbar"),
        content: const Text(
  ...
  static final List<_BlockOption> _blockOptions = TimetableDaily
      .genericAppointmentsSchedule
      .asMap()
      .entries
      .where(
